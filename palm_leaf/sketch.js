...
function setup() {
  ...
  leaves = [];
  for (var i =  0; i < windowWidth+container_scale/2  ; i +=container_scale){
    for (var j =  0 ; j < windowHeight+container_scale/2  ; j+= container_scale){
  ...
  for (var i = container_scale/2 ; i < windowWidth ; i +=container_scale){
    for (var j =container_scale/2 ; j < windowHeight ; j+= container_scale){
